...
export function UrlDialog({ open, onClose, editUrl, onSuccess }: UrlDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        toast.success(
          editUrl 
            ? t("Dashboard.url.updated") 
            : t("Dashboard.url.created"),
          {
            description: editUrl
          ...
          <div className="space-y-3 pt-2">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="useExpiration" className="text-sm">
                  {t("Dashboard.url.use_expiration")}
                </Label>
              </div>
            </div>
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    ...
                    >
                      ...
                      {expiresAt ? format(expiresAt, "PPP") : t("Dashboard.url.pick_date")}
                    </Button>
                  </PopoverTrigger>
          ...
          >
            {loading ? (
              ...
              <span className="flex items-center gap-2">
                ...
                {editUrl ? t("Dashboard.url.update") : t("Dashboard.url.create")}
              </span>
            )}
          </Button>
        </DialogFooter>
